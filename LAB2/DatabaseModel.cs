...
namespace PostgreConsoleInteractorCS
{
    public class DatabaseModel
    {
        ...
        {            
            ...
            Console.WriteLine("1 - select categories by department_id");
            Console.WriteLine("2 - select goods by categoty_id");
            Console.WriteLine("3 - select name by department_id");
            Console.Write("Your choice - ");
            int search = int.Parse(Console.ReadLine());
            switch (search)
            {
                case 1:
                    Console.Write("Input department_id - ");
                    string department_id = Console.ReadLine();
                    NpgsqlCommand command1 = new NpgsqlCommand("SELECT name FROM category WHERE department_id = " + department_id, connection);
                ...
                case 3:
                    Console.Write("Input department_id - ");
                    string department_id3 = Console.ReadLine();
                    NpgsqlCommand command3 = new NpgsqlCommand("SELECT name FROM department WHERE department_id = " + department_id3, connection);
